...
public class DireccionMapper extends MapperDTO<DireccionDTO, Direccion> {
    ...
    public DireccionDTO toDTO(Direccion dir) {
        ...
        dto.setLocalidadId(
                dir.getLocalidad() != null ? dir.getLocalidad().getId()
                        : null);

        dto.setCodigoPostalId(
                dir.getCodigoPostal() != null ? dir.getCodigoPostal().getId()
                        : null);

        dto.setDistritoId(
                dir.getDistrito() != null ? dir.getDistrito().getId()
                        : null);
        ...
        dto.setZonaGeoId(
                dir.getLocalidad() != null && dir.getLocalidad().getZonaGeografica() != null
                        ? dir.getLocalidad().getZonaGeografica().getId()
                        : null);

        dto.setLocalidad(
                dir.getLocalidad() != null ? dir.getLocalidad().getNombre()
                        : null);

        dto.setCodigoPostal(
                dir.getCodigoPostal() != null ? dir.getCodigoPostal().getCodigo()
                        : null);
