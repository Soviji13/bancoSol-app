...
public class TiendaController {
    ...
    public String listarTiendas(@RequestParam(value = "campaniaId", required = false) Long campaniaId,
        ...
        //SUGERENCIA DE LA IA PARA EXPORTAR, no sabia bien como plantearlo sin q fuera una locura, igualmente me ha venido bien saberlo, lo aplicaré a voluntarios
        //pasamos lista a json y la metemos en jsp para q boton exportar no tenga q hacer fetch extra al backend!!!!
        try {
        ...
        //al darle a filtros metemos las listas para selects del menu lateral de los filtros
        if (verFiltros != null && verFiltros) {
            ...
            //conservamos parametros en url para q selects se queden marcados al recargar!!!!!
            // asi no tenemos q hacer un /tienda/filtrada o por el estilo y podemos reutilizar la pintada og de la tabla
    ...
    public String guardarTienda(
            ...
            @RequestParam(value = "campaniaIdTarget", required = false) Long campaniaIdTarget, //donde la vamos a guardar
    ...
    public String modificarTienda(@RequestParam("campaniaId") Long campaniaId,
        ...
        //recuperamos responsables y nos aseguramos de meter el de la tienda por si ya tuviera uno asignado!!!!
        //la logica detras de esto sria q al ser una relacion 1:1, los responsables q ya esten asignados no deben porder
        //asignarse a otra, por lo q si vamos a modificar solo traemos los libres y el nuestro, ya q si lo cambiamos el nuestro
        //pasaria a ser libre.
        ...
        //pasamos array de tiendas otra vez o nos quedamos con tabla en blanco al modificar (me pasó) (IDEA DE SOLUCION DE LA IA, IMPLEMENTACION MIA)
    ...
    public String actualizarTienda(
        ...
        //redirect para evitar recarga y por  tanto guardar mas veces la misma tienda, evitamos errores
    ...
    public String eliminarTienda(@RequestParam("tiendaId") Long tiendaId,
        ...
        //redirect importantisimo para evitar q al recargar intente eliminar una tienda eliminada ya
