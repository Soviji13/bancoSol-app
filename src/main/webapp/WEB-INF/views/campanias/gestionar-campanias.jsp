<%-- Alejandro Jiménez González 85% (15% IA para migrarlo JSTL ) --%>
...
<section class="gestion-campania">
    ...
    <header class="gestion-campania__cabecera">
        <div class="gestion-campania__volver">
            <a href="${pageContext.request.contextPath}/campanias" class="btn-classic">
                Volver
            </a>
        </div>
        ...
        <div class="gestion-campania__titulo">
            ...
            <form action="${pageContext.request.contextPath}/campanias/cambiar-estado" method="post" class="form-estado-campania">
                <input type="hidden" name="id" value="${campania.id}" />
                <input type="hidden" name="nuevoEstado" value="${!estaActiva}" />

                <button type="submit" class="btn-status ${estaActiva ? 'btn-status--activa' : 'btn-status--terminada'}">
                    <c:choose>
    ...
    <div class="gestion-campania__contenido">
        ...
        <section class="gestion-campania__bloque gestion-campania__bloque--acciones">
                                ...
                                <c:otherwise>
                                    <c:forEach var="coord" items="${coordinadores}">
                                        <div class="coordinador-item">
                                            <a href="${pageContext.request.contextPath}/campanias/gestion/coordinador?id=${coord.id}&campania=${campania.id}" class="link-classic">
                                                <c:choose>
            ...
            <nav class="acciones-campania">
                <a href="${pageContext.request.contextPath}/campanias/gestion/modificar?id=${campania.id}" class="btn-action-wide">
                    Modificar Campaña
                </a>
                <a href="${pageContext.request.contextPath}/campanias/gestion/cadenas?id=${campania.id}" class="btn-action-wide">
                    Gestionar Cadenas
                </a>
                <a href="${pageContext.request.contextPath}/campanias/gestion/coordinadores?id=${campania.id}" class="btn-action-wide">
