...
<head>
    ...
    <c:if test="${pagina == 'inicio-voluntarios'}">
        <link rel="stylesheet" href="${pageContext.request.contextPath}/css/tiendas/tiendas.css" /> <%-- reutilizamos estilos generales de tabla --%>

        <%--estilos y scripts propios de voluntarios!!!!--%>
        ...
        <c:if test="${panelIzquierdo == 'voluntarios/voluntarioDetalles.jsp' || panelIzquierdo == 'voluntarios/voluntarioFiltros.jsp'}">
