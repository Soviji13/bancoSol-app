...
<div style="padding: 20px;">
    <h3 style="color: #283593; margin-bottom: 5px; font-size: 16px;">
        <%= coord.getNombreContacto() != null ? coord.getNombreContacto().toUpperCase() : "COORDINADOR" %>
    </h3>
    ...
    <p style="font-size: 13px; margin: 5px 0;"><b>Teléfono:</b> <br><%= coord.getTelefonoContacto() != null ? coord.getTelefonoContacto() : "N/A" %></p>
    <p style="font-size: 13px; margin: 10px 0 5px 0;"><b>Correo electrónico:</b> <br><%= coord.getEmailContacto() != null ? coord.getEmailContacto() : "N/A" %></p>
</div>