    ...
    return (
        <div className="contenedor_contenido contenedor_menu">
            {tipoLateral === "menuLateral" && 
                <NavegadorMenus manejaContenidoInicial={manejaContenidoInicial} contenido={contenidoInicial}/>
            }
            {tipoLateral === "test" && <Ok 
...
function ContenidoInicial ({tipoContenido, manejaContenidoLateral, manejaContenidoInicial}) {
    return (
        <div className="contenedor_contenido contenedor_principal">
            {tipoContenido === "campanias" && <MainCampanias 
                    manejaContenidoLateral={manejaContenidoLateral}
                    manejaContenidoInicial={manejaContenidoInicial}
                />
            }
            {tipoContenido === "coordinadores" && <p>Coordinadores (Funcionalidad en parte de JavaScript)</p>}
            {tipoContenido === "tiendas" && <p>Tiendas (Funcionalidad en parte de JavaScript)</p>}
            {tipoContenido === "colaboradores" && <p>Colaboradores (Funcionalidad en parte de JavaScript)</p>}
            {tipoContenido === "voluntarios" && <MainVoluntarios 
                    manejaContenidoLateral={manejaContenidoLateral}
                    manejaContenidoInicial={manejaContenidoInicial}
                />
            }
            {tipoContenido === "incidencias" && <p>Inicidencias (Funcionalidad en parte de JavaScript)</p>}
