...
<head>
    ...
    <c:if test="${pagina == 'gestionar-coordinadores'}">
        ...
        <script type="module"
                src="${pageContext.request.contextPath}/js/coordinadores/campanias.js"
                defer>
        </script>
    </c:if>

    <c:if test="${pagina == 'campanias'}">
        <link rel="stylesheet" href="${pageContext.request.contextPath}/css/campanias/campanias.css" />

        <script src="${pageContext.request.contextPath}/js/campanias/campanias.js" defer></script>
    </c:if>


    <c:if test="${pagina == 'gestionar-cadenas'}">
        <link rel="stylesheet" href="${pageContext.request.contextPath}/css/campanias/campanias.css" />
    ...
    <c:if test="${pagina == 'gestion-campanias'}">
        ...
        <script type="module"
                src="${pageContext.request.contextPath}/js/campanias/coordinadores.js"
                defer>
        </script>
    </c:if>
</head>
