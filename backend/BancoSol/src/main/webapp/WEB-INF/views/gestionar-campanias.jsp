...
<head>
    ...
    <style>
        /* Tipografía coherente para TODA la página, igual que el resto de tu app */
        ...
        /* El botón verde/rojo de la cabecera */
        .btn-status {
            padding: 6px 20px;
            border-radius: 15px;
            border: none;
        ...
        /* Cajas con scroll para las listas */
        .list-container {
        ...
        /* Ajustes para la cabecera gris clara de las tablitas */
        .th-classic {
            background-color: #fff;
            font-size: 15px;
            padding: 5px;
...
<table border="1" width="100%" height="500" style="border-collapse: collapse;">
    ...
    <tr height="50">
        <td align="center" colspan="2" style="border-top: 1px solid #999;">
            <a href="/campanias">
                <button type="button" class="btn-classic" style="color: #c62828;">Descartar cambios</button>
            </a>
        </td>
    </tr>
</table>
